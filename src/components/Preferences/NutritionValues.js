...
const NutritionValues = ({nutritionValues, preferences}) => {
  return (
    <div className="nutrition-values-list">
      <h3>Cíle</h3>
      <p>Cíle se doplňují automaticky z vypočtených hodnot. Můžete si ale nastavit vlastní. (Vypočtená hodnota kilokalorií je hodnota pro udržení aktuální váhy.)</p>
